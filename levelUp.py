...
image_test = train.flow_from_directory('/test',
     target_size=(150, 150),
     class_mode='categorical')


image_train = train.flow_from_directory('/train',
    target_size=(150, 150),
    class_mode='categorical')
...
accuracy = history.history.get('accuracy')[-1] * 100
file_name = 'acc.txt'
file_open = open(file_name,'w')
file_open.write('{}'.format(accuracy))
file_open.close
